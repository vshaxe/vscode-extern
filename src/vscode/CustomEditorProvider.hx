 ...
 */
typedef CustomEditorProvider<T:CustomDocument> = CustomReadonlyEditorProvider<T> & {
	/**
	 ...
	 */
	final onDidChangeCustomDocument:EitherType<Event<CustomDocumentEditEvent<T>>, Event<CustomDocumentContentChangeEvent<T>>>;
	 ...
	 */
	function backupCustomDocument(document:T, context:CustomDocumentBackupContext, cancellation:CancellationToken):Thenable<CustomDocumentBackup>;
}
