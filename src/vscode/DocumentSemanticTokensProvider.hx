...
typedef DocumentSemanticTokensProvider = {
	 ...
	 */
	@:optional function provideDocumentSemanticTokensEdits(document:TextDocument, previousResultId:String,
		token:CancellationToken):ProviderResult<EitherType<SemanticTokens, SemanticTokensEdits>>;
}
