 ...
 */
typedef LogOutputChannel = OutputChannel & {
	/**
	 ...
	 */
	function trace(message:String, ?args:Rest<Any>):Void;
	 ...
	 */
	function debug(message:String, ?args:Rest<Any>):Void;
	 ...
	 */
	function info(message:String, ?args:Rest<Any>):Void;
	 ...
	 */
	function warn(message:String, ?args:Rest<Any>):Void;
	 ...
	 */
	function error(error:EitherType<String, Error>, ?args:Rest<Any>):Void;
}
