 ...
 */
@:jsRequire("vscode", "TerminalShellIntegration")
extern class TerminalShellIntegration {
	/**
	 ...
	 * }
	 */
	overload function executeCommand(commandLine:String):TerminalShellExecution;
	 ...
	 * }
	 */
	overload function executeCommand(executable:String, args:Array<String>):TerminalShellExecution;
}
