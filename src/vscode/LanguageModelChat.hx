...
typedef LanguageModelChat = {
	 ...
	 */
	var maxInputTokens(default, null):Int;
	 ...
	 */
	function sendRequest(messages:Array<LanguageModelChatMessage>, ?options:LanguageModelChatRequestOptions,
		?token:CancellationToken):Thenable<LanguageModelChatResponse>;
	 ...
	 */
	function countTokens(text:EitherType<String, LanguageModelChatMessage>, ?token:CancellationToken):Thenable<Int>;
}
