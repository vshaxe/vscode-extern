...
extern class TreeItem {
	 ...
	 */
	@:overload(function(resourceUri:Uri,
		?collapsibleState:TreeItemCollapsibleState):Void {}) function new(label:EitherType<String, TreeItemLabel>, ?collapsibleState:TreeItemCollapsibleState);
}
