 ...
 */
typedef TerminalShellExecution = {
	/**
	 ...
	 * }
	 */
	var commandLine(default, null):TerminalShellExecutionCommandLine;
	 ...
	 * }
	 */
	function read():AsyncIterable<String>;
}

typedef AsyncIterable<T> = () -> AsyncIterator<T>;
