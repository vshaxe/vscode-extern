...
extern class NotebookEdit {
	 ...
	 */
	static function updateCellMetadata(index:Int, newCellMetadata:DynamicAccess<Any>):NotebookEdit;
	 ...
	 */
	static function updateNotebookMetadata(newNotebookMetadata:DynamicAccess<Any>):NotebookEdit;
	 ...
	 */
	var newCellMetadata:Null<DynamicAccess<Any>>;

	/**
	 * Optional new metadata for the notebook.
	 */
	var newNotebookMetadata:Null<DynamicAccess<Any>>;
