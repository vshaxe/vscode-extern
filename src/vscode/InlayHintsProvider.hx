 ...
 */
typedef InlayHintsProvider<T:InlayHint = InlayHint> = {
	/**
	 ...
	 */
	function provideInlayHints(document:TextDocument, range:Range, token:CancellationToken):ProviderResult<Array<T>>;
	 ...
	 */
	function resolveInlayHint(hint:T, token:CancellationToken):ProviderResult<T>;
}
