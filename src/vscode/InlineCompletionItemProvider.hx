 ...
 */
typedef InlineCompletionItemProvider = {
	/**
	 ...
	 */
	function provideInlineCompletionItems(document:TextDocument, position:Position, context:InlineCompletionContext,
		token:CancellationToken):ProviderResult<EitherType<Array<InlineCompletionItem>, InlineCompletionList>>;
}
