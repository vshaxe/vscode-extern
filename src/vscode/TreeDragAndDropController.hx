 ...
 */
@:jsRequire("vscode", "TreeDragAndDropController")
extern class TreeDragAndDropController<T> {
	/**
	 ...
	 */
	var dropMimeTypes(default, null):ReadOnlyArray<String>;
	 ...
	 */
	var dragMimeTypes(default, null):ReadOnlyArray<String>;
	 ...
	 */
	overload function handleDrag(source:ReadOnlyArray<T>, dataTransfer:DataTransfer, token:CancellationToken):Null<Thenable<Void>>;
	 ...
	 */
	overload function handleDrag(target:Null<T>, dataTransfer:DataTransfer, token:CancellationToken):Null<Thenable<Void>>;
}
