...
typedef TelemetryLogger = {
	 ...
	 */
	function logUsage(eventName:String, ?data:Map<String, EitherType<Any, TelemetryTrustedValue<Any>>>):Void;
	 ...
	 * @param data The data to log
	 */
	@:overload(function(error:Error, ?data:Map<String, EitherType<Any, TelemetryTrustedValue<Any>>>):Void {})
	function logError(eventName:String, ?data:Map<String, EitherType<Any, TelemetryTrustedValue<Any>>>):Void;
