...
typedef TypeHierarchyProvider = {
	 ...
	 */
	function prepareTypeHierarchy(document:TextDocument, position:Position,
		token:CancellationToken):ProviderResult<EitherType<TypeHierarchyItem, Array<TypeHierarchyItem>>>;
